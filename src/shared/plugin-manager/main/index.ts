...
class PluginManager {
    ...
    private get pluginBasePath() {
        ...
        const nextPluginBasePath = path.resolve(
            app.getPath("userData"),
            "./bakamusic-plugins",
        );
        const legacyPluginBasePath = path.resolve(
            app.getPath("userData"),
            "./musicfree-plugins",
        );
        this._pluginBasePath =
            fsSync.existsSync(nextPluginBasePath) || !fsSync.existsSync(legacyPluginBasePath)
                ? nextPluginBasePath
                : legacyPluginBasePath;
        return this._pluginBasePath;
    }
    ...
    public async setup(windowManager: IWindowManager) {
        ...
        ipcMain.handle("@shared/plugin-manager/uninstall-all-plugins", async () => {
