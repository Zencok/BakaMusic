...
const rendererWritableConfigKeys = new Set<keyof IAppConfig>([
    ...
    "normal.classicAmllPlaybackDetail",
...
const enumConfigValues = new Map<keyof IAppConfig, ReadonlySet<string>>([
    ...
    ["playMusic.defaultQuality", new Set(["96k", "128k", "192k", "320k", "flac", "flac24bit", "hires", "vinyl", "dolby", "atmos", "atmos_plus", "master"])],
    ...
    ["download.defaultQuality", new Set(["96k", "128k", "192k", "320k", "flac", "flac24bit", "hires", "vinyl", "dolby", "atmos", "atmos_plus", "master"])],
